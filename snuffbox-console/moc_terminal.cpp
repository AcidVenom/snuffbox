...
QT_MOC_LITERAL(5, 37, 3)
    ...
    "Terminal\0HandleEvent\0\0ReceiveMsg\0sev\0"
    "msg\0"
};
...
void Terminal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->ReceiveMsg((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Terminal::staticMetaObject = {
    { &QAbstractScrollArea::staticMetaObject, qt_meta_stringdata_Terminal.data,
