...
QT_MOC_LITERAL(4, 24, 3)
    ...
    "Connection\0SendLog\0\0sev\0msg\0"
};
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Connection::*_t)(int , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Connection::SendLog)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Connection::SendLog(int _t1, QString _t2)
{
